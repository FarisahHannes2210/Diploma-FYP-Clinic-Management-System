...
<div class="container">
  <div class="col-md-12 d-flex justify-content-center">
         ...
         <table id = "table" class = "table table-bordered">
           ...
           <tbody><?php
            ...
            <tr>
              ...
              <td><a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href="func_documents.php?deldoc=<?php echo $row['DOCT_ID'];?>">Delete</a></td>
            </tr>
          <?php } ?>
         </table>
      </div>
    ...
    <div class="col-md-4">
      <form enctype="multipart/form-data" action="func_documents.php" method="POST">
