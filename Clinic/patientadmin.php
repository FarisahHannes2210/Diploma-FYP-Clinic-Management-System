  ...
  <?php
    ...
    <div class="container">
      <div class="col-md-12 d-flex justify-content-center">
            ...
            <tbody>
              ...
              while ($row = $result->fetch_array()){?>
                <tr>
                  ...
                  <td><a class = "btn btn-primary" href="patientadmin.php?edit=<?php echo $row['PAT_ID'];?>" class="update_pat_btn"><i class = "glyphicon glyphicon-remove"></i>Edit</a></td>
                  <td><a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href="admin_func_patient.php?delpat=<?php echo $row['PAT_ID'];?>" ><i class = "glyphicon glyphicon-remove"></i>Delete</a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
        ...
        <div class = "col-md-5">
          <!-- //add, update shit -->
          <form class="" action="admin_func_patient.php" method="POST">
