             ...
             <table  id = "table" class = "table table-bordered">
               ...
               <tbody>  <?php
                ...
                <tr>
                  ...
                  <td><a name = 'generate_invoice_btn' class = "btn btn-info"  href="invoiceadmin.php?APP_ID=<?php echo $fetch['APP_ID'];?>"><i class = "glyphicon glyphicon-edit"></i>Generate Invoice</a>
                    <a name = 'generate_invoice_btn' class = "btn btn-primary"  href="mc_patientadmin.php?APP_ID=<?php echo $fetch['APP_ID'];?>"><i class = "glyphicon glyphicon-edit"></i>Generate MC</a></td>
                </tr>
              <?php }
             // } ?>
             </table>
