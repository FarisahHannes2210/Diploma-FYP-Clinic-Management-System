  ...
  <?php
    ...
    <div class="container">
      ...
      <div class="col-md-12 d-flex justify-content-center">
            ...
            <table id = "table" class = "table table-bordered">
              ...
              while ($row = $result->fetch_array()){?>
                <tr>
                  ...
                  <td><a class = "btn btn-primary" href="inventory.php?mededit=<?php echo $row['MED_ID'];?>"><i class = "glyphicon glyphicon-remove">Edit</a></td>
                  <td><a  class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href="func_med.php?delmed=<?php echo $row['MED_ID'];?>"><i class = "glyphicon glyphicon-remove">Delete</a></td>
                </tr>
              <?php } ?>
            </table>
        ...
        <div class="col-md-4">
          <!-- //add, update shit -->
          <form class="" action="func_med.php" method="POST">
