             ...
             <table  id = "table" class = "table table-bordered">
               ...
               <tbody>  <?php
                ...
                <tr>
                  ...
                  <td><center><a name = 'payment_btn' class = "btn btn-warning"  href="payment.php?APP_ID=<?php echo $fetch['APP_ID'];?>"><i class = "glyphicon glyphicon-edit"></i>Pay Fee</a></center></td>
                </tr>
              <?php }
             // } ?>
             </table>
