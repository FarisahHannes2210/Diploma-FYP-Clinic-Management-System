...
<html>
   ...
   <body id="body">
      ...
      <h3 id="myHeader">Your dashboard</h3>
      <div class="container">
             ...
             <table  id = "table" class = "table table-bordered">
               ...
               <tbody>  <?php
                ...
                <tr>
                  ...
                  <td><center><a name = 'update_app' class = "btn btn-info"  href="appointment_detail.php?APP_ID=<?php echo $fetch['APP_ID'];?>"><i class = "glyphicon glyphicon-edit"></i>Update Appointment</a>
                  <a class = "btn btn-danger"  onclick = "confirmationDelete(this); return false;" href="func_appointment.php?delapp=<?php echo $fetch['APP_ID'];?>"><i class = "glyphicon glyphicon-remove"></i>Cancel Appointment</a></center></td>
                </tr>
              <?php }
             // } ?>
             </table>
